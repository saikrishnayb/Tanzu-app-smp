...
$(document).ready(function() {
	...
	$('#delete-pocategory-modal').on("click",'.delete',function(){
		...
		var $deletePOCategoryPromise = $.post('delete-po-category', {poCatId:poCatId});
	...
	$('#delete-subcategory-modal').on("click",'.delete',function(){
		...
		var $deleteSUBCategoryPromise = $.post('delete-sub-category', {subCatId:subCatId});
	...
	$('#sub-category-table').on("click",'.edit-category',function(){
		...
		var $getEditSubCategoryContentPromise =$.get("get-edit-sub-category-content",{subCategoryId:subCategoryId});
	...
	$editSubCategoryModal.on("click",'.save-category-edited',function(){
		...
		if(isValid){
				...
				//var $updateSubCategoryPromise =$.post("update-sub-category",categoryData);
	...
	$addSubCategory.on("click",function(){
		...
		var $addSubCategoryContentPromise =$.get("add-sub-category-modal-content");
	...
	$addSubCategoryModal.on("click",'.save-category',function(){
		...
		if(isValid){
			...
			//var $insertSubCategoryPromise =$.post("insert-sub-category",categoryData);
			var $insertSubCategoryPromise = $.ajax({
				type: "POST",
				url:'./insert-sub-category',
				global: false,
				data: categoryData
			});
