...
$(document).ready(function() {
		...
		if(validateBaicSearchFields())
			{
				...
				var url= getContextRoot()+"/fulfillment/search";
	...
	$usersTable.on("click", ".edit-user", function(){
		...
		var $getEditUserModalContentPromise = $.get('get-edit-user-modal-content', {userId:userId, userType:userType, roleId:roleId});
	...
	$confirmAccountDeactivationModal.on("click", ".deactivate-confirm", function(){
		...
		var $deactivateUserPromise = $.post('deactivate-user', {userId:userId,isVendorUser:isVendorUser});
	...
	$usersTable.on("click", ".edit-vendor-user", function(){
		...
		var userType = "VENDOR";
		var roleId = $this.closest('.user-row').find('.role-id').val();
		var $getEditUserModalContentPromise = $.get('get-edit-vendor-user-modal-content', {userId:userId, userType:userType, roleId:roleId});
...
function deactivteUser($this,$isVendorUser,$confirmAccountDeactivationModal){
	...
	var userId = $this.closest('.user-row').find('.user-id').val();
	var $getDeactivateUserModalContentPromise = $.get('get-deactivate-user-modal-content', {email:email, userId:userId
