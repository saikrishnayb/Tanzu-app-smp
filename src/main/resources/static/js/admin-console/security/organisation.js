...
$(document).ready(function() {
	...
	$orgTable.on("click", ".deactivate", function(){
		...
		var $getDeactivateorgModalContentPromise = $.get('get-deactivate-org-modal-content', {orgName:orgName,orgId:orgId});
	...
	$orgTable.on("click", ".edit-org", function(){
		var $this =  $(this);
		var orgId = $this.closest('.org-row').find('.org-id').val();
		location.assign('./modify-org?orgId=' + orgId);
	});
	
	//deactivate execution
	$confirmOrgDeactivationModal.on("click", ".deactivate-confirm", function(){
		var orgId = $('#org-id').val();
		var $deactivateorgPromise = $.post('delete-org', {orgId:orgId});
