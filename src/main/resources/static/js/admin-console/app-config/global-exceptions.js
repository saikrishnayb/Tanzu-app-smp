$(document).ready(function() {
	...
	$exceptionTable.on("click", ".edit-exception", function(){
		...
		var $editGlobalExceptionModalPromise = $.get("get-global-exceptions-edit-modal", {exceptionId:exceptionId,unitNumber:unitNumber,poNumber:poNumber});
	...
	$exceptionTable.on("click", ".delete-exception", function(){
		...
		var $thisRow = $(this).closest("tr");
		var exceptionId = $thisRow.find(".global-exception-id").val();
		var $deleteGlobalExceptionModalPromise = $.get("get-global-exceptions-delete-modal", {exceptionId:exceptionId});
	...
	$deleteExceptionModal.on("click", ".delete-global-exception-confirm", function(){
		...
		var exceptionId = $('#exception-id-modal').val();
		var $deleteExceptionPromise = $.get("delete-global-exception", {exceptionId:exceptionId});
...
$(".reset").on('click', function(){
	...
	processingImageAndTextHandler('visible','Loading data...');
	window.location.href = 'global-exceptions';
});
