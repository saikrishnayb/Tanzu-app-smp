...
public class SecurityRestControllerV2 {
	...
	private static final Logger LOGGER = LogManager.getLogger(SecurityRestControllerV2.class);
	...
	public ModelAndView getPurchasingDetails(@RequestParam("vendorId") int vendorId) {
		...
		PurchasingSummary purchasingSummary = vendorService.getPurchasingSummary(vendor);
		mav.addObject("vendor", vendor);
		mav.addObject("purchasingSummary", purchasingSummary);
		return mav;
	}
