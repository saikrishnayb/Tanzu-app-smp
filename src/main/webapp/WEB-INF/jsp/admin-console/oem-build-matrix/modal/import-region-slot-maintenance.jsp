...
<head>
	<link href="${baseUrl}/css/admin-console/oem-build-matrix/modal/import-region-slot-maintenance.css" rel="stylesheet" type="text/css" />
</head>
...
<div class="modal-content col-xs-12" data-modal-title="Import Region Slot Maintenance" data-modal-width="400">
	<div class="row modal-body">
		<form id="import-form" class="import-form form-horizontal" action="./import-region-slot-maintenance.htm" method="POST" enctype="multipart/form-data">
			...
			<input type ="hidden" id="regionDesc" name="regionDesc" value="${regionDesc}"/>
	...
	<div class="modal-footer">
		<div class="button-div">
			<a class="buttonPrimary buttonDisabled floatRight"
				id="import-slots-btn" 
				data-slot-desc="${slotType.slotTypeDesc}" 
				data-year="${year}" 
				data-region="${region}"
				data-region-desc="${regionDesc}">Import</a>
		</div>
	</div>
</div>
<script src="${baseUrl}/js/admin-console/oem-build-matrix/modals/import-region-slot-maintenance.js" type="text/javascript"></script>