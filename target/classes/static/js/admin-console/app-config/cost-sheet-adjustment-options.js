...
$optionTable.on('click', '.edit-option', function() {
	...
	var $getOptionPromise = $.get("get-cost-sheet-adjustment-option-modal", {caOptionId: caOptionId});
...
$optionTable.on('click', '.delete-button', function() {
	var caOptionId = $(this).closest('.option-row').find('.option-id').val();
	var $deleteOptionPromise = $.post("delete-cost-sheet-adjustment-option", {caOptionId: caOptionId});
...
function doSave() {
	...
	var $updateOptionPromise = $.post("update-cost-sheet-adjustment-option", $form.serialize());
...
function doAdd() {
	...
	var $form = $optionModal.find('#option-form');
	var $addOptionPromise = $.post("add-cost-sheet-adjustment-option", $form.serialize());
