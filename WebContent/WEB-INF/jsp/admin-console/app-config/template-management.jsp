...
<html>
	<head> 
		...
		<link href="${baseUrl}/css/admin-console/app-config/template-management.css" rel="stylesheet" type="text/css"/>
	...
	<!-- Scripts -->
	<script src="${baseUrl}/js/admin-console/app-config/template-management.js" type="text/javascript"></script>
