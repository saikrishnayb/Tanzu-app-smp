...
<html>
	<head> 
		...
		<link href="${context}/css/admin-console/app-config/unit-exceptions.css" rel="stylesheet" type="text/css"/>
	...
	<!-- Scripts -->
	<script src="${commonStaticUrl}/js/jquery.dataTables.min.js" type="text/javascript"></script>
	<script src="${context}/js/admin-console/app-config/unit-exceptions.js" type="text/javascript"></script>
</html>