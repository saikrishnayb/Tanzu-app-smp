...
<html>
	<head>
		...
		<link href="${context}/css/admin-console/app-config/alerts.css" rel="stylesheet" type="text/css"/>
	...
	<!-- Scripts -->
	<script src="${context}/js/admin-console/app-config/alerts.js" type="text/javascript"></script>
</html>