...
<html>
	<head> 
	    ...
	    <link href="${context}/css/admin-console/app-config/subject-management.css" rel="stylesheet" type="text/css"/>
	...
	<!-- Scripts -->
	<script src="${context}/js/admin-console/app-config/subject-management.js" type="text/javascript"></script>
</html>