...
<html>
	<head> 
		...
		<link href="${pageContext.request.contextPath}/css/admin-console/components/category-management.css" rel="stylesheet" type="text/css"/> 
	</head>
	<body>
			...
			<div class="leftNavAdjacentContainer">
				...
				<div class="row">
							...
							<tbody>
								...
								<tr class="category-row">
									<td class="editable centerAlign po-cat-id" style="display: none">
										...
										<a>
											<img src="${commonStaticUrl}/images/delete.png" class="centerImage rightMargin delete-category"/>
										</a>
 				...
 				<!--  Modals -->
					...
					<div class="modal" id="add-sub-category-modal">
	...
	<!-- Scripts -->
	<script src="${context}/js/admin-console/components/category-management.js" type="text/javascript"></script>
</html>