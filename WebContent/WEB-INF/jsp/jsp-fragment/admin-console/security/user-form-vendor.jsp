...
<div id="ldap-userinfo-modal" class="modal" title="LDAP User Info">
<p id="infoText"></p>
				...
				<div class="user-form-container">
					<form id="user-form-vendor" <c:if test="${isCreatePage == true}"> action="${pageContext.request.contextPath}/admin-console/security/create-user.htm"  </c:if> 
						...
						<div class="single-line-content first-name-container" <c:if test = "${isCreatePage == true && currentUser.userTypeId == 1}">class="displayNone"</c:if>>
							...
							<input id="first-name" name="firstName" type="text" class="input alpha alpha-name " value="${editableUser.firstName}" />
						</div>
						...
						<div class="single-line-content last-name-container" <c:if test = "${isCreatePage == true && currentUser.userTypeId == 1}">class="displayNone"</c:if>>
							...
							<input id="last-name" name="lastName" class="input alpha alpha-name " type="text" value="${editableUser.lastName}" />
						</div>
						...
						<div class="single-line-content phone-container" <c:if test = "${isCreatePage == true && currentUser.userTypeId == 1}">class="displayNone"</c:if>>
							...
							<input id="phone" class="input phone numeric numeric-phone  optional" name="phone" type="text" value="${editableUser.phone}" /> 
							<input id="extension" class="input extension optional numeric numeric-extension " name="extension" type="text" value="${editableUser.extension}" placeholder="ext." />
						</div>
