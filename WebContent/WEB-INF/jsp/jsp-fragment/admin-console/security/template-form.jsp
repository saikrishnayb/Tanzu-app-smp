					...
					<table id="template-Component-table" >
						...
						<tbody>
							...
							<tr class="template-comp-row">
								<td class="template-comp" style="display: none"></td>
								<td class="template-comp">${comps.componentName}<div id="template-comp-tr-${status.index}" class="displayNone"><c:if test="${comps.editable eq true}">1~~9</c:if></div>
								...
								<input name="componentList['${status.index}'].componentName" id="componentName-${status.index}"  class="org-id" type=hidden value="${comps.componentName}"/>
								</td>
								...
								<c:if test="${comps.editable ne true}">  disabled </c:if> /></td>
