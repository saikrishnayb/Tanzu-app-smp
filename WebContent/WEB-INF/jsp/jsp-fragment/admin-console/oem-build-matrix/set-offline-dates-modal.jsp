...
<c:set var="modalName" value="Offline Dates - ${plantData.plantManufacturer} - ${plantData.plantName}, ${plantData.state}" />
<div class="modal-content col-xs-12" data-modal-title="${modalName}" data-modal-width="470">
	<div class="row modal-body">
		<form id="set-offline-date-form">
			...
			<input type="hidden" value="${plantData.plantManufacturer}" id="plantManufacturerHidden"> 
			<input type="hidden" value="${plantData.plantName}" id="plantNameHidden"> 
			<input type="hidden" value="${plantData.state}" id="stateHidden"> 
