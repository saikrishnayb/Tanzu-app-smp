...
<%@ taglib uri="/WEB-INF/tld/taglib.tld" prefix="tl"%>
		...
		<div class="leftNavGroup"><a href="${baseAppUrl}/admin-console/oem-build-matrix/business-award-maint.htm" id="left-nav-business-award-maint" onclick="javascript:loadProcessImage();">Business Award Maintenance</a></div>
		<div class="leftNavGroup" style="color: #666666;font-weight: normal;">Body Plants</div>
		<div><a href="${baseAppUrl}/admin-console/oem-build-matrix/bodyplant-capabilities.htm" id="left-nav-bodyplant-capabilities" onclick="javascript:loadProcessImage();">Capabilities</a></div>
		...
		<div><a href="${baseAppUrl}/admin-console/oem-build-matrix/maintenance-summary.htm" id="left-nav-maintenance-summary" onclick="javascript:loadProcessImage();">Body Plant Maintenance Summary</a></div>
		...
		<div class="leftNavGroup"><a  href="#"  id="left-nav-prod-slot-maintenance">Production Slot Maintenance</a></div>
		<div class="leftNavGroup"><a href="${baseAppUrl}/admin-console/oem-build-matrix/build-history.htm" id="left-nav-build-history" onclick="javascript:loadProcessImage();">Build History</a></div>
