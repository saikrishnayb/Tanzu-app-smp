...
<%@ taglib uri="/WEB-INF/tld/taglib.tld" prefix="tl"%>
	...
	<tl:isAuthorized tabName="Admin Console" secFunction="MANAGE_CATEGORY_ASSOCIATION">
		<div class="leftNavGroup"><a href="${baseAppUrl}/admin-console/components/category-association.htm" id="left-nav-category-association" onclick="javascript:loadProcessImage();">Category Association</a></div>
	</tl:isAuthorized> 
	
	<tl:isAuthorized tabName="Admin Console" secFunction="MANAGE_CATEGORY">
		<div><a href="${baseAppUrl}/admin-console/components/category-management.htm" id="left-nav-category-management" onclick="javascript:loadProcessImage();">Category Management</a></div>
	</tl:isAuthorized>
	
	<tl:isAuthorized tabName="Admin Console" secFunction="MANAGE_COMPONENTS">
		<div class="leftNavGroup"><a href="${baseAppUrl}/admin-console/components/component-management.htm" id="left-nav-component-management" onclick="javascript:loadProcessImage();">Component Management</a></div>
	</tl:isAuthorized>
