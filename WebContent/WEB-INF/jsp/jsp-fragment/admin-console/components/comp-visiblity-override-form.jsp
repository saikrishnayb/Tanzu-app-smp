	...
	<div class="visiblity-form-container" style="width: 50%">
		<form id="visiblity-override-form"   method="POST">
			...
			<div class="single-line-content" style="margin-top: 10px;">
				...
				<select id="poCategoryAssocId" class="input numeric numeric-whole" name="poCategoryAssocId" style="width: 190px;">
			...
			<div class="single-line-content" style="margin-top: 10px;">
				...
				<input id="dependentComponentName" name="dependentComponentName" type="text" size="23" class="input alpha alpha-numeric" value="${editOverride.dependentComponentName}"  readonly="readonly"/>&nbsp;<a id="dependentComponentSel"><img src="${commonStaticUrl}/images/search.png"/></a>
			...
			<div class="single-line-content" style="margin-top: 10px;">
				...
				<select id="overrideType" class="input alpha alpha-numeric" name="overrideType" style="width: 190px;">
					<option value=''>        Select         </option>
			...
			<div class="single-line-content" style="margin-top: 10px;">
				...
				<input id="controllingComponentName" name="controllingComponentName" type="text" size="23" class="input alpha alpha-numeric optional" value="${editOverride.controllingComponentName}" readonly="readonly"/>&nbsp;<a id="controllingComponentSel"><img src="${commonStaticUrl}/images/search.png"/></a>
			...
			<div class="single-line-content" style="margin-top: 18px;">
				...
				<textarea rows="5" cols="24" id="controllingValue" name="controllingValue" class="input alpha alpha-numeric optional">${editOverride.controllingValue}</textarea>
			</div>
		</form>
	</div>
